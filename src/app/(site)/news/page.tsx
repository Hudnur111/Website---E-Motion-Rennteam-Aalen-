...
export const metadata: Metadata = {
  title: "News",
  description:
    "Aktuelle News des E-Motion Rennteams Aalen: Ergebnisse, Ankündigungen und Neuigkeiten rund um Team und Fahrzeuge.",
    ...
    <div className="container-page py-20">
      <Reveal>
        ...
        <p className="mt-4 max-w-2xl text-muted">
          Ergebnisse, Ankündigungen und Neuigkeiten rund um das E-Motion Rennteam Aalen.
        </p>
      </Reveal>

      {posts.length === 0 ? (
        <p className="mt-14 text-muted">Es sind noch keine News vorhanden.</p>
      ) : (
